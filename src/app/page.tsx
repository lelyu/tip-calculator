  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row gap-2 mt-4">
        <Card tip_percentage={customTip} bill_amount={billAmount} />
        <Card tip_percentage={18} bill_amount={billAmount} />
        <Card tip_percentage={20} bill_amount={billAmount} />
        <Card tip_percentage={22} bill_amount={billAmount} />
        <Card tip_percentage={25} bill_amount={billAmount} />
      </div>
    </>
  );
}
